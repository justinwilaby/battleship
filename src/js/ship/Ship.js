...
class Ship {
  ...
  constructor(shipModel, movable = true) {
    ...
    Object.assign(this, {shipModel, movable});
  }
  ...
  set movable(value) {
    ...
    if (value) {
      ...
      element.removeEventListener('mousedown', this.elementMouseDownHandler);
    }
  }
